<template>
    <v-container fluid >
        ...
        <!-- Finish Dialog (mínimo necesario para /finish) -->
            ...
            <v-card>
                ...
                <v-card-text>
                    <v-form ref="finishFormRef" v-model="finishValid">
                        <v-row>
                            <v-col cols="12" md="4">
                                <v-text-field v-model.number="finishForm.consumption" type="number" min="0" step="0.1"
                                              label="Consumo (PEN)"/>
                            </v-col>
                            <v-col cols="12" md="4">
                                <v-select v-model="finishForm.payment_method" :items="paymentMethods"
                                          label="Método de pago" :rules="[req]"/>
                            </v-col>
                            <v-col cols="12" md="4">
                                <v-text-field v-model.number="finishForm.rate_per_hour" type="number" min="0" step="0.1"
                                              label="Tarifa cierre (opcional)"/>
                            </v-col>
                            <v-col cols="12" md="6">
                                <v-text-field v-model.number="finishForm.discount" type="number" min="0" step="0.1"
                                              label="Descuento (opcional)"/>
                            </v-col>
                            <v-col cols="12" md="6">
                                <v-text-field v-model.number="finishForm.surcharge" type="number" min="0" step="0.1"
...
import PoolTableFormDialog from "@/tenant/pages/control/MesaForm.vue"; // tu componente de formulario
import API from "@/tenant/services/index.js"; // usa tu wrapper
